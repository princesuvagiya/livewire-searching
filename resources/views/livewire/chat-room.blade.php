 <div class="mt-4 bg-white reunded-lg shadow-md p-6" x-data="{{ json_encode(['message' => $messages , 'messageBody' => '']) }}" x-init="
        Echo .join('demo')    
         ...
         <template x-for="message in messages" :key="message.id">
             <div class="my-8">
                 ...
                 <div class="flex flex-row justify-between border-b border-gray-200">
                     ...
                     <span class="text-gray-500" x-text="message.created_at"></span>
                 </div>
     ...
     >
      <input
         ...
         x-model="messageBody"
         class="mr-4 shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-"
         type="text"
